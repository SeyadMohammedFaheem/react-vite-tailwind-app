...
const SelectedProjects = () => {
  return (
    <section className="pt-[160px]">
      <h2 className="text-4xl font-denton md:text-5xl font-semibold font-playfair text-[#111] mb-2">SELECTED</h2>
      <h3 className="text-4xl font-denton md:text-4xl italic font-playfair text-[#111] mb-12">PROJECTS</h3>
